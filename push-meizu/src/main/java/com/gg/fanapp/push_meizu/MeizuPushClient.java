...
public class MeizuPushClient implements IPushClient {
    ...
    public void register() {
        ...
        PushManager.switchPush(mContext, mAppId, mAppKey, PushManager.getPushId(mContext), 0, true);
        PushManager.switchPush(mContext, mAppId, mAppKey, PushManager.getPushId(mContext), 1, false);
    }
    ...
    public void unRegister() {
        ...
        if (!TextUtils.isEmpty(token)) {
            PushManager.unRegister(mContext, mAppId, mAppKey);
